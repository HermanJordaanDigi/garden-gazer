...
export default function Index() {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-10 shadow-md" style={{
      backgroundColor: '#738678'
    }}>
        <div className="container max-w-6xl mx-auto px-4 py-3 bg-[#386641]">
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex-1">
              ...
              <Input placeholder="Search for a plant..." value={search} onChange={e => setSearch(e.target.value)} className="pl-10 bg-white/90 border-0" />
            </div>

            <Button size="icon" variant="ghost" onClick={() => navigate("/add-plant")} className="text-white hover:bg-white/20">
          ...
          <div className="flex justify-center mt-3">
            <ToggleGroup type="single" value={viewMode} onValueChange={value => value && setViewMode(value as 'searches' | 'collection')} className="bg-white/90 rounded-lg p-1">
          ...
          <div className="flex gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="z-50">
                ...
                {typeOptions.map(option => <DropdownMenuItem key={option} onClick={() => setFilters(prev => ({
                ...prev,
                type: option
              }))}>
                    {option}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="z-50">
                ...
                {sunOptions.map(option => <DropdownMenuItem key={option} onClick={() => setFilters(prev => ({
                ...prev,
                sunExposure: option
              }))}>
                    {option}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="z-50">
                ...
                {windOptions.map(option => <DropdownMenuItem key={option} onClick={() => setFilters(prev => ({
                ...prev,
                windTolerance: option
              }))}>
                    {option}
                  </DropdownMenuItem>)}
              </DropdownMenuContent>
